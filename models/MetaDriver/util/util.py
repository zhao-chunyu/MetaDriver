...
def get_save_path(args):
    ...
    # args.snapshot_path = 'exp4/{}/split{}/{}/model'.format(args.data_type, args.split, backbone_str)
    # args.result_path = 'exp4/{}/split{}/{}/result'.format(args.data_type, args.split, backbone_str)

    # args.snapshot_path = 'exp3/{}/split{}/{}/model'.format(args.data_type, args.split, backbone_str)
    # args.result_path = 'exp3/{}/split{}/{}/result'.format(args.data_type, args.split, backbone_str)
    # args.snapshot_path = 'exp2/{}/split{}/{}/model'.format(args.data_type, args.split, backbone_str)
    # args.result_path = 'exp2/{}/split{}/{}/result'.format(args.data_type, args.split, backbone_str)
    # args.snapshot_path = 'exp1/{}/split{}/{}/model'.format(args.data_type, args.split, backbone_str)
    # args.result_path = 'exp1/{}/split{}/{}/result'.format(args.data_type, args.split, backbone_str)
    args.snapshot_path = 'exp/{}/split{}/{}/model'.format(args.data_type, args.split, backbone_str)
    args.result_path = 'exp/{}/split{}/{}/result'.format(args.data_type, args.split, backbone_str)
...
########################################################
'''
Function: Test the metrics during training, torch version, 
          do not do the final test calculation metrics
        ------------------------  
...
def sim(s_map, gt):
    ...
    return torch.mean(torch.sum(torch.min(s_map_norm, gt_norm), 1))
